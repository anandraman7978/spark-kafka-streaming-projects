...
#topic = app.topic("org.chicago.cta.station.arrivals.v2", value_type=Station)
topic = app.topic("org.chicago.cta.stations", value_type=Station)


# TODO: Define the output Kafka Topic
# out_topic = app.topic("TODO", partitions=1)out_topic = app.topic("org.chicago.cta.stations.table.v1", partitions=1)
